            ...
            lg:px-4">
                <div class="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                    <div
                        ...
                        <a type="button" href="<?php echo e(route('products.index')); ?>" style="text-decoration:none"
...
unset($__errorArgs, $__bag); ?>"
                                            name="name" value="<?php echo e(old('name')); ?>" placeholder="Masukkan Nama Product">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MIG12998\Herd\uts_filiana\resources\views/products/create.blade.php ENDPATH**/ ?>