                    ...
                    <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                        <div
                            ...
                            <img src="{{ asset('storage/products/' . $product->image) }}"
                                alt="storage/products/{{ $product->image }}" class="object-cover object-center">
                        </div>
                        <div class="sm:col-span-8 lg:col-span-7">
                            ...
                            <section aria-labelledby="information-heading" class="mt-2">
                                ...
                                <p style=" margin-top:10pt">{{ $product->description }}</p>
                                {{-- <p style=" margin-top:10pt" x-text="product->idProduct"></p> --}}
                                <!-- Reviews -->
                                    ...
                                    <div class="mt-10">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <a class="text-sm font-medium text-indigo-600 hover:text-indigo-500"
                                                style="text-decoration:none">{{ $product->stock }} {{ $product->satuan }}
                                            </a>
